...
module.exports = {
	...
	retryPolicy: {
		...
		factor: 2,
		// A function to check failed request.
	...
	// Tracking request and waiting for running request before shutdowning. More info: https://moleculer.services/docs/0.13/fault-tolerance.html
	tracking: {
		// Enable feature
		enabled: false,
